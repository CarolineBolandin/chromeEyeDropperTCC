...
import { findcolor, getImage } from './myFunctions'
...
class ToolTip extends Tool {
    constructor() {
        ...
        this.el = createNode('img', {
            id: 'color-tooltip',
            src: chrome.runtime.getURL("img/branco.png"),
            style: [
                'z-index: 1000001',
                'color: black',
                'position: absolute',
    ...
    hookColor(args: {
        ...
        const imgsrc = chrome.runtime.getURL(getImage(perto))
        const img = <HTMLImageElement>this.el
        img.src = imgsrc
    }
}
